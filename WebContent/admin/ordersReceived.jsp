...
<body>
<div style="color: white; text-align: center; font-size: 30px;"><img src="../icon/orderrnew.png" alt="orderrnew">  Orders Received </div>
<%
            ...
            <td><%=rs.getString("total") %>  </td>
             ...
             <td><%=rs.getString("orderDate") %></td>
              <td><%=rs.getString("deliveryDate") %></td>
               ...
               <td><a href="cancelOrdersAction.jsp">Cancel </a></td>
                <td><a href="deliveredOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1) %>">Delivered </a></td>
            </tr>
         <%}
        }
        	catch(Exception e)
